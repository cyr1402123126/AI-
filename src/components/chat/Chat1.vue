  ...
  <div id="chatting" scroll="no">
    ...
    <div ref="scrollBottom" style="overflow: auto;height: 85vh;padding-bottom: 1.3rem" @click="hideEmotion">
      <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
        <div ref="up" class="content" v-for="(value,index) in arr" :key="index">
          <div class="message" v-for="(item,index) in value" :key="index">
            <!--meMessage-->
            <div id="meMes" class="clearfix" v-if="item.type==0">
              <div class="time" v-if="item.timeShow">
  ...
  export default {
    ...
    data(){
      return {
        ...
        arr:{
          up2:[
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好;#衰;',read:'未读',type:1,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈鸿真',src:require('@/assets/images/logo.png'),content:'大家好',read:'未读',type:0,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈鸿真',src:require('@/assets/images/logo.png'),content:'大家好',read:'未读',type:0,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈鸿真',src:require('@/assets/images/logo.png'),content:'大家好',read:'未读',type:0,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:1},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:1,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:1},
            ...
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:0,timeShow:true,time:"2018-11-01 08:35"},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:0},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:1},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:0},
            {name:'陈某某',src:require("@/assets/images/logo.png"),content:'大家好',read:'未读',type:0},
    ...
    methods: {
      ...
      onRefresh() {
        setTimeout(() => {
          ...
          this.count++;
          let data={test:[{name:'陈某某',src:require("@/assets/images/logo.png"),content:'测试数据;#衰;',read:'未读',type:1,timeShow:true,time:"2018-11-01 08:35"},
            ...
            this.arr=Object.assign(data,this.arr)
         /* data.forEach(val=>{
